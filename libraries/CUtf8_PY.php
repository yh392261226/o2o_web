...
class CUtf8_PY
{
    ...
    public static function encode($utf8Data, $sRetFormat='head')
    {
        ...
        if ('head' === $sRetFormat)
            return implode('', $aBuf);
        if ('first' === $sRetFormat)
            return substr(implode('', $aBuf), 0, 1);
        else
            return implode(' ', $aBuf);
    }
...
//example
//echo CUtf8_PY::encode('公司'); //编码为拼音首字母:gs
//echo CUtf8_PY::encode('公司', 'first'); //编码为拼音首字母后仅获取首个字母:g
//echo CUtf8_PY::encode('公司', 'all'); //编码为全拼音:gongsi
?>
