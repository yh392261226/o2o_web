<?php
namespace MLIB\EMAY;
require_once(SCRIPT_ROOT . 'nusoap.php');
/**
 * 验证流程概要:
 *
...
class Client{
	 ...
	 *
	 */
	function __construct($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
    {
    	$this->Client($url,$serialNumber,$password,$sessionKey,$proxyhost,$proxyport,$proxyusername, $proxypassword, $timeout, $response_timeout);
    }
