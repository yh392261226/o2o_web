...
* @access public
*/
class nusoap_fault extends \MLIB\EMAY\nusoap_base {
	/**
	...
	*/
	...
	{
		$this->nusoap_fault($faultcode,$faultactor,$faultstring,$faultdetail);
	}
 ...
 */
class soap_fault extends \MLIB\EMAY\nusoap_fault {
}
...
* @access   public
*/
class nusoap_xmlschema extends \MLIB\EMAY\nusoap_base  {
	...
	*/
	...
	{
		$this->nusoap_xmlschema($schema,$xml,$namespaces);
	}
...
* @access   public
*/
class soapval extends \MLIB\EMAY\nusoap_base {
	/**
	...
	*/
	...
	{
		$this->soapval($name,$type,$value,$element_ns,$type_ns,$attributes);
	}
...
* @access public
*/
class soap_transport_http extends \MLIB\EMAY\nusoap_base {
...
* @access   public
*/
class nusoap_server extends \MLIB\EMAY\nusoap_base {
	/**
...
class wsdl extends \MLIB\EMAY\nusoap_base {
	...
	{
		$this->wsdl($wsdl,$proxyhost,$proxyport,$proxyusername,$proxypassword,$timeout,$response_timeout,$curl_options,$use_curl);
	}
...
* @access   public
*/
class nusoap_parser extends \MLIB\EMAY\nusoap_base {
 ...
 * Backward compatibility
 */
class soap_parser extends \MLIB\EMAY\nusoap_parser {
}
...
* @access   public
*/
class nusoap_client extends \MLIB\EMAY\nusoap_base  {
	...
	*/
	...
	{
		$this->nusoap_client($endpoint,$wsdl,$proxyhost,$proxyport,$proxyusername, $proxypassword, $timeout, $response_timeout, $portName);
	}
