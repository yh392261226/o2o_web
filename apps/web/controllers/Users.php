...
class Users extends \CLASSES\WebBase
{
    ...
    public function favorateTasks()
    {
        ...
        $favorate_arr = $dao_favorate -> listData(array('users_favorate.u_id'=>$u_id,'f_type'=>0,'leftjoin'=>array('task_ext_info','task_ext_info.t_id = users_favorate.f_type_id'),'join'=>array('tasks',"tasks.t_id = users_favorate.f_type_id"),'fields'=>'tasks.t_title,tasks.t_id,tasks.t_amount,tasks.t_duration,tasks.t_author,tasks.t_status,f_id,task_ext_info.t_desc','pager'=>false));
